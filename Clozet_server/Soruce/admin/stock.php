...
?>
			<form method="post" name="stockForm" action="">
				<tr onclick="changeImage('<?=$PrdImage?>', this);" style="cursor:pointer;">
					...
					<td><a href="<?=$PrdUrl?>" target="_blank"><?=$PrdName?></a></td>
					...
					<td style="text-align:center;"><input type="text" name="stock_count" style="border:none; width:60px; height:30px; font-size:16px; text-align:center;"><input type="button" value="반영" name="stockSubmit" onclick="" style="background-color:#eee; width:50px;"></td>
				</tr>
			</form>
<?
			}
